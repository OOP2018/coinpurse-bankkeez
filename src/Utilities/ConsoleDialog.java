...
public class ConsoleDialog {
	...
	// The dialog receives a Purse object by dependency injection (as parameter
	// to constructor)
	...
	public void depositDialog() {
		...
		while (scanline.hasNextDouble()) {
			...
			Valuable value2 = makeMoney(value);
			System.out.printf("Deposit %s... ", value2.toString());
			boolean ok = purse.insert(value2);
	...
	public void withdrawDialog() {
		// Check to see if user typed amount to withdraw on the same line as
		// "w".
